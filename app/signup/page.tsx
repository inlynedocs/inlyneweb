                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            className={`${inputClass} border-black focus:ring-black ${emailError ? 'border-red-500 focus:ring-red-500' : ''
                                }`}
                        />
                        {checkingEmail}
                        {emailError && (
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            className={`${inputClass} border-black focus:ring-black ${usernameError ? 'border-red-500 focus:ring-red-500' : ''
                                }`}
                        />
                        {checkingUsername}
                        {usernameError && (
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            className={`${inputClass} border-black focus:ring-black ${confirm === '' || passwordsMatch ? '' : 'border-red-500 focus:ring-red-500'
                                }`}
                        />
